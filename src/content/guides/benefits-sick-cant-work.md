---
title: "What Benefits Can I Claim If I'm Sick and Can't Work?"
description: "If illness or injury has stopped you working, you may be entitled to several benefits. This guide explains what's available, who qualifies, and where to start."
category: "pip"
...
For a structured estimate of how descriptors may score, use our free [PIP checker](/pip-checker/).
...
1. last full wages
2. SSP / occupational sick pay period
3. UC claim date and expected first payment
4. ESA claim date if relevant
5. PIP claim date (slower, but important)
6. Council Tax Reduction start date
...
- **GOV.UK — PIP**: start a PIP claim by phone or follow the online process where available; use our [PIP checker](/pip-checker/) to prepare
